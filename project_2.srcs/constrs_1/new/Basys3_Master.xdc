...
#_property PACKAGE_PIN W13 [get_ports {sw7}]					
...
#Pmod Header JA
#Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {lSensor}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lSensor}]
#Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {mSensor}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {mSensor}]
#Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {rSensor}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rSensor}]
##Sch name = JA4
...
##Sch name = JA8
#set_property PACKAGE_PIN K2 [get_ports {ENA}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {ENA}]
##Sch name = JA9
#set_property PACKAGE_PIN H2 [get_ports {ENB}]					
...
#Pmod Header JC
#Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {IN1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {IN1}]
#Sch name = JC2
...
#Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {IN4}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {IN4}]
###Sch name = JC7
##set_property PACKAGE_PIN L17 [get_ports {JC[4]}]					
#	#set_property IOSTANDARD LVCMOS33 [get_ports {JC[4]}]
###Sch name = JC8
set_property PACKAGE_PIN M19 [get_ports {ENA}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ENA}]
#Sch name = JC9
set_property PACKAGE_PIN P17 [get_ports {ENB}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ENB}]
#Sch name = JC10
